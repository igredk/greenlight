...
func (app *application) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
	...
	// so it's safe to add any headers that we want to include.
...
// Reads a string value from the query string and then splits it into a slice on the comma character.
